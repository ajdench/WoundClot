...
If choosing for an IFAK, EMS, tactical, workplace catastrophic-bleed kit, or austere major haemorrhage use, the evidence hierarchy points to:
...
This is not medical advice or a substitute for local clinical governance, TCCC/TECC protocols, or device Instructions for Use. Hemostatic products are adjuncts; technique, wound packing, pressure, reassessment, and rapid evacuation remain decisive.

## Pages

- [Comparative Analysis](comparative-analysis.md)
- [Product Comparison](product-comparison.md)
- [Product Family Variants](product-family-variants.md)
