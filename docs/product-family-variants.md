...
WoundClot product lines include EMS/First Responder and Hospital variants. The EMS/First Responder line is the most relevant to this wiki's prehospital traumatic hemorrhage question. Surgical, hospital, or dental evidence may support general hemostatic plausibility but should not be treated as equivalent to field trauma evidence.
...
When comparing studies or buying products, match:

1. **same wound problem**: external compressible, junctional, extremity, internal solid organ, surgical oozing;
2. **same product format**: gauze, ribbon, pad, granules, applicator, sponge, adhesive;
3. **same endpoint**: initial hemostasis, rebleeding, survival, removal, complications;
4. **same user context**: layperson, EMS, tactical medic, ED, operating room.

If those differ, the comparison is still informative but should be down-weighted.
